...
\begin{frame}
\frametitle{PASW data types}

\begin{center}
\includegraphics[width=0.5\textwidth]{1-2_data_basics/figures/SPSS_Types_of_Variables/Types_of_Variables}

\url{http://goo.gl/sOqsbH}
\end{center}

\begin{itemize}
\item Click on the Variable View tab at the bottom. \pause
\item Nominal=Categorical and Scale=Numerical \pause
\item Define categories in the Values Column. \pause
\item View$\rightarrow$Value Labels to see categories.
\end{itemize}
...
\dq{Does there appear to be a relationship between number of hours studied per week and GPA?}
